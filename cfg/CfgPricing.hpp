class CfgPricing
{
  ...
  //custom EXTRA VEHICLES:
	class B_Heli_Transport_01_EPOCH { price = 3500; };
	class B_Heli_Transport_01_camo_EPOCH { price = 3500; };
	class B_Heli_Transport_03_black_F { price = 3500; };
	class B_Heli_Transport_03_F { price = 3500; };
	class B_mas_CH_47F { price = 3500; };
	//class B_mas_UH60M_SF { price = 3000; };
	//class B_mas_UH60M { price = 3000; };
  
	class B_Heli_Transport_03_unarmed_green_F { price = 2500; };
    //class B_mas_UH60M_MEV { price = 2500; };
	class B_mas_UH1Y_MEV_F { price = 2500; };
	class B_mas_UH1Y_UNA_F { price = 2500; };
    //class O_mas_MI8 { price = 2500; };
    //class I_mas_MI8 { price = 2500; };

	class O_G_Offroad_01_armed_F { price = 2500; };
	class I_G_Offroad_01_armed_F { price = 2500; };
	class B_G_Offroad_01_armed_F { price = 2500; };
	class B_MRAP_01_hmg_F { price = 3000; };
	class O_MRAP_02_hmg_F { price = 3000; };
	class I_MRAP_03_hmg_F { price = 3000; };
	class I_mas_cars_LR_soft_m2 { price = 3000; };
	class B_mas_cars_LR_m2 { price = 3000; };
	class B_mas_HMMWV_SOV_M134 { price = 3500; };
	class B_mas_HMMWV_M134 { price = 3500; };
	class B_mas_HMMWV_M134_des { price = 3500; };
	class B_mas_HMMWV_M2 { price = 3000; };
	class B_mas_HMMWV_SOV_M2 { price = 3000; };

	class B_mas_cars_LR_Med { price = 1250; };
	class B_mas_cars_LR_Unarmed { price = 1250; };
	class B_mas_HMMWV_UNA { price = 1250; };
	class B_mas_HMMWV_UNA_des { price = 1250; };
	class B_mas_HMMWV_MEV { price = 1250; };
	class B_mas_HMMWV_MEV_des { price = 1250; };
	class O_MRAP_02_F { price = 2500; };
	class I_MRAP_03_F { price = 2500; };
	class I_mas_cars_UAZ_Unarmed { price = 1000; };
	class I_mas_cars_UAZ_Med { price = 1000; };
	class O_mas_cars_UAZ_Unarmed { price = 1000; };
	class O_mas_cars_UAZ_Med { price = 1000; };
