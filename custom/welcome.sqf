...
_role1 = "Welcome to";
_role1names = ["Gankers Club"];
_role2 = "Admins";
_role2names = ["Beani Gank Jimmy B Stat"];
_role3 = "Server mod";
_role3names = ["Epoch ","Altis"];
_role4 = "Server antihack<br />by";
_role4names = ["EpochMod Team"];
_role5 = "Server Mods";
_role5names = ["AI Missions", "High Loot", "More traders", "More mods"];
_role6 = "Website";
_role6names = ["www.fastpointgaming.com"];
_role7 = "Twitter";
_role7names = ["@BeaniGamer"];
_role8 = "Email Support";
_role8names = ["support@fastpointgaming.com"];
_role9 = "Special Thanks";
_role9names = ["Gankers Club Team"];
